          ...
          <div>
            ...
            <div className="space-y-4 text-center">
              <p className="text-gray-300 flex items-center justify-center gap-2">
                <FaEnvelope className="text-gray-400" /> Email: renniekawangu@gmail.com
              </p>
              <p className="text-gray-300 flex items-center justify-center gap-2">
                <FaLinkedin className="text-gray-400" /> LinkedIn: <a href="#" className="text-gray-400 hover:underline font-medium">Your LinkedIn</a>
              </p>
              <p className="text-gray-300 flex items-center justify-center gap-2">
                <FaGithub className="text-gray-400" /> GitHub: <a href="#" className="text-gray-400 hover:underline font-medium">Your GitHub</a>
              </p>
              <p className="text-gray-300 flex items-center justify-center gap-2">
                <FaFacebook className="text-gray-400" /> Facebook: <a href="#" className="text-gray-400 hover:underline font-medium">Your Facebook</a>
              </p>
              <p className="text-gray-300 flex items-center justify-center gap-2">
                <FaInstagram className="text-gray-400" /> Instagram: <a href="#" className="text-gray-400 hover:underline font-medium">Your Instagram</a>
              </p>
            </div>
          </div>
        </div>
